...
btn2.addEventListener("click", () => {
    ...
    .then(resp=>resp.json()) //응답 객체를 매게변수로 얻어와 파싱
...
// 웹소켓 테스트
// 1.SockJS 라이브러리 추가 
// 2. sockJS를 이용해서 클라이언트용 웹 소켓 객체 생상
