...
function accessId() { //함수 선언
    ...
    // 2) div1의 배경색을 변수에 저장
    // js에서 css 관련 속성을 다룰떄는 style을 이용함 
...
function accessClass() {
    ...
    for (var i = 0; i < div2Arr.length; i++)
        div2Arr[i].style.backgroundColor = "rgb(140,180," + (i * 100) + ")";
}
...
function cssTest() {
    ...
    //  querySelectorAll() : 일치하는 모든 요소 선택(배열 반환)
