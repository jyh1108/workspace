...
// 클래스가 remove-row인 여소 중 첫 번째 요소 
document.querySelector(".remove-row").addEventListener("click", (e) => {

    console.log(e.target); //이벤트가 빌셍힌 요소
