...
COMMENT ON COLUMN "MEMBER".MEMBER_GENDER IS '성별(N/F)';
...
COMMENT ON COLUMN "BOARD"."BOARD_NO" IS '개시글 번호(시퀀스 SEQ_BOARD_NO)';
...
COMMENT ON COLUMN "COMMENT"."BOARD_NO" IS '개시글번호(FK)';
...
--BOARD 테이블 샘플데이터 3게 삽입
INSERT INTO "BOARD"
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', '내용1 입니다\n안녕하세요',DEFAULT,DEFAULT,DEFAULT,3);
INSERT INTO "BOARD"
...
-- 게시글 목록 조회
-- 게시글번호, 제목, 작성자(이름), 작성일, 조회수,댓글 수
-- 최신 게시글이 위쪽으로 오도록 정렬 

SELECT BOARD_NO, BOARD_TITLE, MEMBER_NM, CREATE_DT, READ_COUNT,
(SELECT COUNT(*) FROM "COMMENT"SUB WHERE SUB.BOARD_NO =MAIN.BOARD_NO
...
-- 특정 게시글 댓글 수
SELECT COUNT(*) FROM "COMMENT" WHERE BOARD_NO =2;
...
--댓글 삽입 
INSERT INTO "COMMENT"
        VALUES(SEQ_COMMENT_NO.NEXTVAL,'테스트1' ,DEFAULT,DEFAULT,1, 1);
