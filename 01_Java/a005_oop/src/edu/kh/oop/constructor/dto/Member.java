...
public class Member {
	...
	// 클래스 초기화 블럭
	// - 프로그램 실행 시 static 변수들 초기화 하는 용도의 블럭
	// (프로그램 실행 시 1 회만 수행됨)
	static {
	...
	public Member(String memberId, String memberPw, String memberName, int memberAge) {
		...
		System.out.println("매게변수 생성자(String,String,String,int)로 생성");
	...
	// 2. (중요!) 매개변수의 자료형 || 개수 || 순서 중 하나라도 달라야한다!
