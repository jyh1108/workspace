...
public class SwitchEx {
	 ...
	 * 
	 * [작성법]
	 * switch(식){ // 식 수행 결과는 true/false가 아닌 값(정수, 문자열 제일 많이씀)
	 * 
	 * case 결과값 1 : 수행코드1; break;
	 * case 결과값 2 : 수행코드2; break;
	 * case 결과값 3 : 수행코드3; break;
	 * default : 모든 case가 만족하지 않을경우 수행하는 코드;
	 * 
	 * }
	 */
	// switch 예시 1
...
//		Math.random() * 3 // 0.0 <= random * 3 < 3.0
	...
	public void ex4() {
		...
		switch(pul) {
		case "+" :System.out.printf("%d %s %d = %d", num1,pul,num2, num1+num2);
		 break;
		...
		case "/" : if(num2 == 0) {
			...
			System.out.printf("%d %s %d = %.3f", num1,pul,num2, (double)num1/num2);
		} break;
	
		case "%" :System.out.printf("%d %s %d = %d", num1,pul,num2, num1%num2);
	 break;
		
		default : System.out.println("존재하지 않은 연산자입니다."); 
		}
	}
