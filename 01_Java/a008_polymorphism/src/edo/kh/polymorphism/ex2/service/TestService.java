package edo.kh.polymorphism.ex2.service;

import java.util.Scanner;

import edo.kh.polymorphism.ex2.dto.*;
// * : (별, 애스터리스크) : 모든, ALL
public class TestService {
	...
	public void ex1() {
		...
		//Animal a = new Animal();
		//Animal cannot be resolved to a type : 객체화 할 수 없는 타입이다.
		// -> 추상클래스이기 때문에!
...
//		KH k = new KH(); // 객체 생성 x
	...
	public void ex3() { 
		...
		int a = 7;
		int b = 4;
		Calculator cal = new JYHCalculator();
