...
if (imageInput != null) { // 화면에 imageInput이 있을 경우 
    ...
    imageInput.addEventListener("change", e => {
        ...
        if (file == undefined) { // 파일을 한번 선택한 후 취소 했을때
        ...
        //매게변수에 작성된 파일을 읽어서 저장 후
        // 파일을 나타내는 url을 result 속성으로 얻어올 수  있기함
