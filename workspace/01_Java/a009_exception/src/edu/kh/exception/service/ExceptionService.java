...
public class ExceptionService {
	...
	public void ex1() throws IOException {
		// 해당 메서드 내에서 IOException이 발생하는 것을
		// 대비한 확인하기
		// 예외(Exception) 확인하기
		...
		// 발생시킬(던질) 가능성이 있기 때문에
		// 그 상황에 대한 대비책 (예외처리)를 하라고 경보하는 것.
	...
	public void ex2() {
		...
		System.out.println("try-catch가 수행되도 프로그렘이 종료되지 않음");
	}
	...
	public void ex4() {
			...
			try {
				...
				e.printStackTrace();
				//Trace : 추적하다
				// -> 예외가 발생한 지점까지는 stack메모리를 추적하여 출력
