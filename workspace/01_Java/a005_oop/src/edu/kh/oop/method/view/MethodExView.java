...
public class MethodExView {
	...
	private void menu3() {
		...
		System.out.println("[1부터 10사이의 난수 5게를 저장한 배열을 반환 받아 출력]");
