package edu.kh.control.roop.ex;
...
public class ForEx {
	...
	public void ex5() {
		...
		System.out.printf("%d부터 %d까지의 모든 정수의 합 : %d", input1, input2, sum );
	}
