...
import a010_java_api_dto.Student;
import a010_java_api_service.APIService;
...
public class APIView {
		...
		public void displayMenu() {
			...
			do { 
				...
				System.out.println("5. String Buffer/Builder");
				System.out.println("6.문자열을 계속 입력 받아 한번에 출력");
...
//			-> 객체주소를 이용해서 만든 정수를 반환
		...
		private void ex5() {
			...
			// delelte(int start, int end) : 삭제(start이상 end 미만)
			sb.delete(3, 5);
		...
		private void ex7() {
			...
			System.out.println(Integer.BYTES); //byte 단위크기
			System.out.println(Integer.SIZE);	//bit 단위 ㅡ 크기
			 ...
			 * Unboxing : Wraper Class 객체 -> 기본 자료형
			 * 
			 * AutoBoxing / AutoUnboxing
			 * - 사용자가 신경쓰지않아도 
			 *   상화에따라 기본 자료형 <-> Wrapper Class 객체로
			 *   자동으로 변환하는 것듳
			 * */
		}
...
//			 Thu Jan 01 09:00:00 KST 1970
			...
			System.out.println("햔재시간 - 기준시간 (ms) : " + 
...
//						분   초    ms
			...
			SimpleDateFormat sdf2 = new SimpleDateFormat("G yyyy년 MM월 HH시 mm분 ss초");
