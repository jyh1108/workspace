package a010_java_api_service;

import a010_java_api_dto.Student;

public class APIService {

	// API (Application Programming InyerFares)
	// 응용 프로그래밍 접점
	...
	public APIService() {
		...
		studentList[2] = new Student(3, 5, 12, "박민재");
	}
	 ...
	 */
	public boolean addStduent(int grade, int classRoom, int number, String name) {

		int index = 0; // 비어 있는 index를 저장
