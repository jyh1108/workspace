...
//			System.out.println(set.toString());
			...
			// - Set에 저장된 객체 중 같은 객체를 찿아 제거
			//   같은 객체가 있어서 제거되면 turn / 아니면 false
			...
			while(it.hasNext()) {
				//it.hashNext() : 다음 꺼내올 객체가 존재하면 true
		...
		public void ex2() {
			...
			// === Hash가 붙은 Set/Map hashcode()를 이용해서 중복 판단
			
			//최종 결론 : Hash가 붙은 Set/Map을 사용하려면
			//equals(), hashCode(), 오버라이딩이 필수 입니다
