package edo.kh.polymorphism.ex1.service;

import java.util.Scanner;

import edo.kh.polymorphism.ex1.dto.Car;
import edo.kh.polymorphism.ex1.dto.LightCar;
import edo.kh.polymorphism.ex1.dto.Truck;
...
public class CarService {
	...
	public void ex1() {
		...
		//c2의 자료형이 Car
		// -> Truck 객체를 참조하더라고 Car 부분만 볼 수 있
//		c2.setWeight(2.5); // c2 로 접근 불가능하여 에러
	...
	public void ex2() {
		/* 업 캐스팅 : 자식 -> 객체 -> 부모 객체로 변환 */
		
		//다운 캐스팅 : 부모 객체 -> 자식객체로 변환
...
//		c1.getDiscountOffer();
	...
	public void ex3() {
		...
		for(Car c :carList) {
			...
			if( c instanceof Truck) {
				...
				// ex)LightCar객체를 Truck 참조변수가 참조하려고 할 때
				...
				System.out.println(" 할인율 : " + ((LightCar)c)
						.getDiscountOffer() * 100 + "%");
			}else {
				//c가 참조하는 객체가 Truck, LightCar가 아닐때
	...
	public void ex4() {
		...
		//객체배열 + 다형성(업캐스팅/다운캐스팅) + instanceof + 매개변수에 다형성 
		//+ 바인딩(정적/동적)
